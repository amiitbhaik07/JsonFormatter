...
public class JSonFormatter {
	...
	static JFrame frame = new JFrame("JSon & XML Formatter cum Beautifier ~ Amit_Bhaik");
	static JPanel p1;
	...
	public static void main(String args[]) throws Exception {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(null, "Unable to Format and Beautify!\n" + e1.getMessage(),
							"JSon & XML Formatter cum Beautifier ~ Amit_Bhaik", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		 ...
		 * JOptionPane.showMessageDialog(null, "Please enter a Name to save",
		 * "JSon & XML Formatter cum Beautifier ~ Amit_Bhaik",
		...
		editLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					try {
						prefs = Preferences.userNodeForPackage(JSonFormatter.class);
					} catch (Exception e3) {
					}

					final JFrame f = new JFrame("Credentials ~ Amit_Bhaik");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					compare.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							try {
									...
									if (!(jsonStr1.trim().equals("")) && !(jsonStr2.trim().equals(""))
										...
										try {
											...
											JOptionPane.showMessageDialog(null,
													...
													"JSon Compare ~ Amit_Bhaik", JOptionPane.INFORMATION_MESSAGE);
								...
								// Compare ~ Amit_Bhaik",
								// JOptionPane.ERROR_MESSAGE);
								JOptionPane.showMessageDialog(null, e3.getMessage(), "JSon Compare ~ Amit_Bhaik",
										JOptionPane.ERROR_MESSAGE);
							}
						}
					...
					JOptionPane.showMessageDialog(null, "Error in Comparing JSon!\n" + e1.getMessage(),
							"JSon Compare ~ Amit_Bhaik", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
